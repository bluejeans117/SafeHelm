...
import org.fsociety.safehelm.adapters.UserRecyclerAdapter;
import org.fsociety.safehelm.models.ClusterMarker;
import org.fsociety.safehelm.models.User;
import org.fsociety.safehelm.models.UserLocation;
import org.fsociety.safehelm.util.MyClusterManagerRenderer;
import org.fsociety.safehelm.util.ViewWeightAnimationWrapper;

import java.util.ArrayList;
import java.util.List;

import static org.fsociety.safehelm.Constants.MAPVIEW_BUNDLE_KEY;
...
public class UserListFragment extends Fragment implements
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (mUserLocations.size() == 0) { // making sure list isn't duplicated by navigating back
...
//                        Log.d(TAG, "run: latlng: " + latLng.toString());
    ...
    private void setCameraView() {
        ...
        // Map boundaries with dimensions 0.2*0.2
